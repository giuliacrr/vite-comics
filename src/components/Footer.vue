...
<template>
  <div>
    <!--Start buy section-->
    <div class="bg-primary neg-margin-shop">
      <div class="container">
        <div class="d-flex pt-5 pb-5 justify-content-between">
    ...
    <!--Start Sign-up and follow-up section-->
    <div class="sign-n-follow">
      <div class="container">
        <div class="d-flex justify-content-between">
          <div>
          ...
          <div class="d-flex align-items-center">
            <span class="text-uppercase text-primary fw-bold me-3"
              >follow us</span
            >
            <img
              class="social-icon"
    ...
    <!--End Sign-up and follow-up section-->
  </div>
</template>
